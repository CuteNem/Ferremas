...
from .serializers import categoriaSerializer, usuarioSerializer, productoSerializer, consultaSerializer, ventaSerializer, detalleSerializer, detalleCompradoSerializer, detalleConProductoSerializer, transaccionSerializer, rolSerializer, UsuarioSerializer2
...
class CrearUsuarioAPI(APIView):
    def post(self, request):
        print("Entro a crear usuario")
        try:
            serializer = UsuarioSerializer2(data=request.data)
